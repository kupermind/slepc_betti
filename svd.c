...
//  ierr = MatView(A, PETSC_VIEWER_STDOUT_WORLD);
  ...
  */
  ...
  ierr = PetscPrintf(PETSC_COMM_WORLD,"  SVDSetOperator...\n", n, m);CHKERRQ(ierr);

  /*
     Set solver parameters at runtime
  */
  ierr = SVDSetFromOptions(svd);CHKERRQ(ierr);
  ierr = PetscPrintf(PETSC_COMM_WORLD,"  SVDSetFromOptions...\n", n, m);CHKERRQ(ierr);
  ...
  ierr = PetscPrintf(PETSC_COMM_WORLD,"  SVDSolve...\n", n, m);CHKERRQ(ierr);
